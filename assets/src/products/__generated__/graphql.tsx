...
export type ProductFragment = (
  { __typename?: 'Product' }
  & Pick<Product, 'id' | 'externalId' | 'name' | 'nameSlug' | 'description' | 'serviceNameSlug' | 'referenceEnabled' | 'referenceLabel' | 'referenceHint' | 'priceFixed' | 'price'>
  & { gatewayAccount: (
    { __typename?: 'GatewayAccount' }
    & Pick<GatewayAccount, 'id' | 'externalId'>
    & { service: (
      { __typename?: 'Service' }
...
export type ProductPaymentFragment = (
  { __typename?: 'ProductPayment' }
  & Pick<ProductPayment, 'id' | 'externalId' | 'reference' | 'amount' | 'status' | 'nextUrl'>
  & { product: (
    { __typename?: 'Product' }
    & ProductFragment
  ), payment: Maybe<(
...
export type GetProductPaymentQuery = (
  { __typename?: 'RootQueryType' }
  & { productPayment: (
    { __typename?: 'ProductPayment' }
...
export type SubmitPaymentMutation = (
  { __typename?: 'RootMutationType' }
  & { payment: (
    { __typename?: 'ProductPayment' }
    & ProductPaymentFragment
...
export type GetProductPaymentComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<GetProductPaymentQuery, GetProductPaymentQueryVariables>, 'query'> & ({ variables: GetProductPaymentQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const GetProductPaymentComponent = (props: GetProductPaymentComponentProps) => (
      <ApolloReactComponents.Query<GetProductPaymentQuery, GetProductPaymentQueryVariables> query={GetProductPaymentDocument} {...props} />
    );
 ...
 * });
 */
export function useGetProductPaymentQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetProductPaymentQuery, GetProductPaymentQueryVariables>) {
        return ApolloReactHooks.useQuery<GetProductPaymentQuery, GetProductPaymentQueryVariables>(GetProductPaymentDocument, baseOptions);
      }
export function useGetProductPaymentLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetProductPaymentQuery, GetProductPaymentQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetProductPaymentQuery, GetProductPaymentQueryVariables>(GetProductPaymentDocument, baseOptions);
        }
export type GetProductPaymentQueryHookResult = ReturnType<typeof useGetProductPaymentQuery>;
export type GetProductPaymentLazyQueryHookResult = ReturnType<typeof useGetProductPaymentLazyQuery>;
export type GetProductPaymentQueryResult = ApolloReactCommon.QueryResult<GetProductPaymentQuery, GetProductPaymentQueryVariables>;
export const CreatePaymentDocument = gql`
    mutation CreatePayment($serviceNameSlug: String!, $nameSlug: String!) {
  payment: createProductPayment(serviceNameSlug: $serviceNameSlug, nameSlug: $nameSlug) {
    ...ProductPayment
  }
}
    ${ProductPaymentFragmentDoc}`;
...
export const SubmitPaymentDocument = gql`
  ...
  payment: submitProductPayment(id: $id) {
    ...
    ${ProductPaymentFragmentDoc}`;
export type SubmitPaymentMutationFn = ApolloReactCommon.MutationFunction<SubmitPaymentMutation, SubmitPaymentMutationVariables>;
export type SubmitPaymentComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<SubmitPaymentMutation, SubmitPaymentMutationVariables>, 'mutation'>;

    export const SubmitPaymentComponent = (props: SubmitPaymentComponentProps) => (
      <ApolloReactComponents.Mutation<SubmitPaymentMutation, SubmitPaymentMutationVariables> mutation={SubmitPaymentDocument} {...props} />
    );
 ...
 * });
 */
export function useSubmitPaymentMutation(baseOptions?: ApolloReactHooks.MutationHookOptions<SubmitPaymentMutation, SubmitPaymentMutationVariables>) {
        return ApolloReactHooks.useMutation<SubmitPaymentMutation, SubmitPaymentMutationVariables>(SubmitPaymentDocument, baseOptions);
      }
export type SubmitPaymentMutationHookResult = ReturnType<typeof useSubmitPaymentMutation>;
export type SubmitPaymentMutationResult = ApolloReactCommon.MutationResult<SubmitPaymentMutation>;
export type SubmitPaymentMutationOptions = ApolloReactCommon.BaseMutationOptions<SubmitPaymentMutation, SubmitPaymentMutationVariables>;