...
export type GatewayAccountFragment = { __typename?: "GatewayAccount" } & Pick<
  GatewayAccount,
  "id" | "externalId" | "type" | "paymentProvider" | "serviceName"
> & {
    credentials:
      ...
      | { __typename?: "SandboxCredentials" };
    cardTypes: Array<
      { __typename?: "CardType" } & Pick<CardType, "id" | "brand" | "type">
    >;
  };

export type CardTypesFragment = { __typename?: "CardType" } & Pick<
  CardType,
  "id" | "brand" | "label" | "type"
>;
...
export type GetPaymentQuery = { __typename?: "RootQueryType" } & {
  ...
  cardTypes: Array<{ __typename?: "CardType" } & CardTypesFragment>;
};
